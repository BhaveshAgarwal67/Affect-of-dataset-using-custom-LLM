...
@st.cache_resource
def load_assets():
    with open("assets/char_mapping_harry.json", "r") as f:
        data = json.load(f)
    ...
    state_dict = torch.load("assets/harry_potter.pth", map_location='cpu')
...
st.title("Harry Potter Narrative Generator")
st.markdown("Generates stylized narrative fiction based on the Harry Potter books.")
prompt = st.text_input("Enter a prompt:", "Harry walked into")
